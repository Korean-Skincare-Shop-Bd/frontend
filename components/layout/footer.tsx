...
import { Crown, Facebook, Instagram, Mail, Twitter, Youtube, Phone } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/categories?limit=5`);
        ...
        <div className="gap-8 grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="space-y-6 md:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl golden-text">KOREAN SKINCARE SHOP BD</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Discover premium beauty products with our curated collection of skincare, makeup, and wellness items. Quality and elegance in every product.
            </p>
            <div>
              <h4 className="mb-3 font-semibold text-white">Follow Us</h4>
              <div className="flex space-x-3">
                <Link href="https://www.facebook.com/koreanskincarebd01" target="_blank" rel="noopener noreferrer" className="hover:bg-gray-800 p-2 rounded-full text-gray-400 hover:text-primary transition-all">
                  <Facebook className="w-5 h-5" />
                </Link>
                <Link href="https://www.instagram.com/koreanskincareshop.bd/?fbclid=IwY2xjawLCQxlleHRuA2FlbQIxMABicmlkETFvaGJCNXhMTHZNQkYycmNvAR7tWZ2DtDj9Mw5egbu53veP8IjPKAxizJoMrBlh0XUGKhNc-fJ5fNuCG0kb2A_aem_qWiwm07QHyXIFOkKw0otLw#" target="_blank" rel="noopener noreferrer" className="hover:bg-gray-800 p-2 rounded-full text-gray-400 hover:text-primary transition-all">
                  <Instagram className="w-5 h-5" />
                </Link>
                <Button asChild variant="ghost" size="icon" className="hover:bg-gray-800 text-gray-400 hover:text-primary transition-all">
                  <Link href="mailto:koreanskincareshopbd1@gmail.com" target="_blank" rel="noopener noreferrer">
                    <Mail className="w-5 h-5" />
                  </Link>
                </Button>
                <Button asChild variant="ghost" size="icon" className="hover:bg-gray-800 text-gray-400 hover:text-primary transition-all">
                  <Link href="https://wa.me/8801534554311" target="_blank" rel="noopener noreferrer">
          ...
          {/* Categories */}
          <div className="space-y-4">
            <h3 className="font-semibold text-white text-lg">Shop Categories</h3>
            <nav className="space-y-3">
              {isLoadingCategories ? (
